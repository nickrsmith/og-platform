...
1. Adapt asset types (Royalties → O&G Assets)
2. Update transaction types for O&G deals
3. Add Category A/B/C contract logic
4. Implement O&G-specific revenue distribution
5. Add override trading contracts

## See Also

- `../CODE_REUSE_MAPPING.md` - What to reuse vs. adapt

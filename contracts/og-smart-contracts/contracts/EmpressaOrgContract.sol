...
contract EmpressaOrgContract is AccessControl, IEmpressaStructs {
     ...
     * @notice This function uses the new Empressa fee structure (2% Empressa + 0.002% referral)
     */
    function calculateCreatorAmount(uint256 grossPrice) public view returns (uint256) {
        ...
        // New structure: 2% Empressa + 0.002% referral = 2.002% total fees
        // Creator receives: 100% - 2.002% = 97.998%
        uint256 totalFeePct = 200 + 2; // 200 basis points (2%) + 2 basis points (0.002%) = 202 basis points
        
        // Creator receives: grossPrice * (10000 - totalFeePct) / 10000
        uint256 creatorAmount = grossPrice * (10000 - totalFeePct) / 10000;
    ...
    function calculateGrossPrice(uint256 creatorAmount) public view returns (uint256) {
        // New structure: 2% Empressa + 0.002% referral = 2.002% total fees
        uint256 totalFeePct = 200 + 2; // 202 basis points
        
        // Gross price = creatorAmount * 10000 / (10000 - totalFeePct)
        uint256 grossPrice = creatorAmount * 10000 / (10000 - totalFeePct);

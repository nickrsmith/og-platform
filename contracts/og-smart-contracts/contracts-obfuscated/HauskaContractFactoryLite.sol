...
contract EmpressaContractFactoryLite {
    ...
    constructor(address _v3b7ca2) {
        if (_v3b7ca2 == address(0)) revert InvalidAddress();
        _vd033e2 = _v3b7ca2;
        emit _ed9b4cb(address(0), _v3b7ca2);
    }
        ...
        returns (address _vd23b59)
    {
        ...
        RoleWiringLibLite._f6e1c68(_vd0b565, _v9b2fda, _v45f631, _vedea5b, _vd23b59);
    ...
    function _f906454(address _vd23b59) external _mc87f2a {
        ...
        RoleWiringLibLite._fefb056(_vd0b565, _v9b2fda, _v45f631, _vedea5b, _vd23b59);
